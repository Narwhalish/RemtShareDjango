...
searchresults = requests.get("http://www.zillow.com/webservice/GetSearchResults.htm?zws-id=X1-ZWz1gfdi9irh1n_1sm5d&address=2114+Bigelow+Ave&citystatezip=Seattle%2C+WA")
